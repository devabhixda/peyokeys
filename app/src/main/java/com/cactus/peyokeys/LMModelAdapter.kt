...
class LMModelAdapter(
    private val models: List<CactusModel>,
    private val selectedModelSlug: String,
    private val onDownloadClick: (CactusModel, Int) -> Unit,
    private val onModelSelected: (CactusModel) -> Unit
) : RecyclerView.Adapter<LMModelAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textModelName.text = model.name
